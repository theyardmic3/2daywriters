...
export const AboutHero = () => {
  ...
  return (
    <section className="container -mt-16 w-full">
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
        <div className="text-center space-y-8">
          <Badge variant="outline" className="text-xs py-2">
            <Badge>About Todaywriting</Badge> Who We Are
          </Badge>
     ...
     <p className="max-w-screen-sm mx-auto text-lg smallPhone:text-xs mediumPhone:text-sm largePhone:text-base smallTablet:text-lg largeTablet:text-xl laptop:text-2xl desktop:text-3xl desktop:w-full hdr:w-full hdr:text-4xl">
